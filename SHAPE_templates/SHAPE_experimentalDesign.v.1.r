...
shape_workDir <- "/home/jdenc017/project/jdenc017/shapeValidation/" #"R:/Research_Data/SimulationRuns/rSHAPE_validation/"
...
shape_init_distPars <- c(factor = 10, random = 1), c(factor = 100, random = 1), c(factor = 1000, random = 1)
...
shape_const_focal_popValue <- 1e6
...
shape_const_distParameters <- c(100), c(100)
...
shape_const_distAsS <- FALSE, FALSE
